...
window.MATH_TOOLS_DATA = [
  ...
  {
    "id": "tool_1781062454468",
    "title": "歡樂花片數學世界",
    "grade": "一年級",
    "description": "專為國小低年級學生設計的互動式數學自學工具——「🌸 歡樂花片數學世界 🌸」。該網頁透過具體的操作介面，將抽象的數學概念轉化為具體的視覺體驗，有效輔助兒童的數學奠基。\n\n💡 核心功能與特色\n多階自學地圖：涵蓋從基礎的「10以內數數與湊十」，到進階的加減法、比較大小，以及「湊十法」與「借十法」等核心數學邏輯。\n\n具體操作教具：整合數位化「十格陣」與彩色花片，支援觸控與滑鼠拖曳，讓學生在動手操作中建立數感。\n\n素養導向題庫：題目結合貼近生活的實例（如摘草莓、分餅乾），並提供「換一組新題目」功能，隨機生成多元的情境題。\n\n即時回饋機制：內建數位數字鍵盤，學生輸入答案後可立即送出檢查，引導自主修正。\n\n這款工具能有效引導孩子從「具體操作」過渡到「抽象算式」，是師長輔助孩子建立早期數學邏輯的實用數位資源。",
